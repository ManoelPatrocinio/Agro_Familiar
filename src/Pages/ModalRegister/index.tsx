    ...
    >
      <div className="modal-dialog modal-xl relative w-auto pointer-events-none">
        <div className="modal-content bg-white  border-none shadow-lg relative flex flex-col md:flex-row w-full h-auto md:h-[34rem] items-center justify-start rounded mt-10">
          ...
          <div className="w-full md:w-3/5 h-full flex flex-col justify-around  px-8  pb-2 pt-4 md:pt-0">
            <header className="w-full ">
              ...
              <p className="w-full md:text-center text-justify text-sm md:text-md text-gray-700 font-display">
                Junte-se a nós, e ajude a desenvolver a agricultura familiar da
                sua região, e, por que não, de todo o Brasil ?
              </p>
              <button
                type="button"
            ...
            <div className="mt-6 md:mt-0">
              ...
              <div className="w-full flex flex-col md:flex-row justify-between items-center">
                ...
                <div className="w-[11rem] p-3 border border-gray-200 rounded my-4 md:my-0">
                  <img
                    src={iconEntity}
                    alt="icone comprador"
